...
```json
{
  ...
  "subtitle": {
    "fa": "بهترین کسب‌وکارها، محصولات و خدمات را اینجا پیدا کنید",
    "ar": "اكتشف أفضل الأعمال والمنتجات والخدمات هنا",
    "en": "Discover the best businesses, products, and services here"
  },
  "action": {
    "label": {
      "fa": "همه موارد را ببین",
      "ar": "عرض الكل",
      "en": "View All"
    },
    "url": "/explore"
  ...
  "items": [
    {
      ...
      "description": {
        "fa": "یک کافه دنج با بهترین قهوه‌های شهر",
        "ar": "مقهى هادئ مع أفضل القهوة في المدينة",
        "en": "A cozy café with the best coffee in town"
      },
